...
namespace EmployeeDetails.Controllers
{
    ...
    public class PersonalDetailsController : ControllerBase
    {
        ...
        public PersonalDetailsController(IBMContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != personalDetail.EmployeeId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<PersonalDetail>> PostPersonalDetail(PersonalDetail personalDetail)
        {
            if (_context.PersonalDetails == null)
            {
                return Problem("Entity set 'IBMContext.PersonalDetails'  is null.");
            }
            ...
            {
                if (PersonalDetailExists(personalDetail.EmployeeId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetPersonalDetail", new { id = personalDetail.EmployeeId }, personalDetail);
        }
        ...
        {
            return (_context.PersonalDetails?.Any(e => e.EmployeeId == id)).GetValueOrDefault();
        }
    }
}